...
Call log:
  ...
  - waiting for locator('#pickup-input')
    12 × locator resolved to <input dir="auto" id="pickup-input" autocomplete="off" spellcheck="false" class="location-input" aria-label="Pickup location" onblur="onLocBlur('pickup')" onfocus="onLocFocus('pickup')" oninput="onLocInput('pickup');updateClearBtn('pickup')"/>
       - unexpected value ""
